...
/***/ function(module, exports, __webpack_require__) {
	...
	var logbookEvents = __webpack_require__(12);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://dry-falls-97353.herokuapp.com/',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.signOutSuccess).catch(ui.failure);
	};

	var onSignUpClose = function onSignUpClose() {
	  $('.signup-field').val('');
	  $('#sign-up-message').text('');
	};

	var onSignInClose = function onSignInClose() {
	  $('.signin-field').val('');
	  $('#sign-in-message').text('');
	};

	var onChangePassClose = function onChangePassClose() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess() {
	  var account = $('#account-name-signin').val();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logApi = __webpack_require__(13);
	var logUi = __webpack_require__(14);
	var getFormFields = __webpack_require__(8);

	var onIndex = function onIndex(event) {
	  event.preventDefault();
	  logApi.getIndex().then(logUi.indexSuccess).catch(logUi.failure);
	};

	var onCreate = function onCreate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  logApi.create(data).then(logUi.createSuccess).then(logApi.getIndex).then(logUi.indexSuccess).catch(logUi.createEntryFailure);
	};
	...
	var onUpdate = function onUpdate(event) {
	  ...
	  var data = getFormFields(event.target);
	  var id = data.post.id;
	  logApi.update(id, data).then(logUi.updateSuccess).then(logApi.getIndex).then(logUi.indexSuccess).catch(logUi.updateEntryFailure);
	};

	var onRemovePost = function onRemovePost(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  logApi.destroy(id).then(logUi.removePostSuccess).then(logApi.getIndex).then(logUi.indexSuccess).catch(logUi.failure);
	};

	var unhideUpdate = function unhideUpdate() {
	  $('#update-entry').removeClass('hidden');
	  $('#create-entry').addClass('hidden');
	};

	var hideUpdate = function hideUpdate() {
	...
	var addAjaxHandlers = function addAjaxHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexHandlebars = __webpack_require__(15);
	...
	var indexSuccess = function indexSuccess(data) {
	  ...
	  var postsIndexHtml = indexHandlebars({ posts: data.posts });
	...
	var createEntryFailure = function createEntryFailure() {
	  $('.create-entry-message').text('Please fill out all fields with the proper input');
	};

	var updateEntryFailure = function updateEntryFailure() {
	  $('.update-entry-message').text('Please fill out all fields with the proper input');
	};

	var removePostSuccess = function removePostSuccess() {
	...
	module.exports = {
	  ...
	  createEntryFailure: createEntryFailure,
	  updateEntryFailure: updateEntryFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n <!-- Developers, why are we using data-id and not just id? -->\n  <div class=\"handlebars-container col-xs-4\">\n    <h2 class=\"postData\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Animal: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.animal_type : stack1), depth0))
	    + "</h1>\n    <ul class=\"entry-text\">\n    <li>\n      Location of Sighting: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\n  </li>\n  <li>\n      Date of Sighting: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date_seen : stack1), depth0))
	    + "\n  </li>\n  <li>\n      Description of Animal: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "\n  </li>\n  <li>\n  <p>Post ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>\n</li>\n<li>\n  <button id=\"removePost\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</button>\n</li>\n  </ul>\n  <!-- <button class=\"deletePostPrompt\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete</button>\n  <div class=\"deleteConfirmation hidden\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.posts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
